...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def _build_ui(self):
        ...
        # Presets
        presets_box = QtWidgets.QGroupBox("Developemental stage")
    ...
    def apply_preset(self, kind: str):
        PRESETS = {
            ...
            "larva": {
                "ui": dict(
                    fps=15, thresh=25, area_min=50, area_max=12000, morph=1,
                    invert=False, fit="Convex Hull", fast=False,
                    bg="KNN", combine="OR (SAFE)", bg_lr=0.006,
